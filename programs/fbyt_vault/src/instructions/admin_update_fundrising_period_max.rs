...
#[derive(Accounts)]
pub struct AdminUpdateFundrisingPeriodMax<'info> {
    #[account(mut)]
...
pub fn admin_update_fundrising_period_max(
    ...
    ctx.accounts.admin_pool.fundrising_period_max = new_fundrising_period_max;
    emit!(AdminPoolUpdateFundrisingPeriodMaxEvent {
