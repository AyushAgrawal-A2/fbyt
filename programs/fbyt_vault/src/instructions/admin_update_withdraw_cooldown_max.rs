...
#[derive(Accounts)]
pub struct AdminUpdateWithdrawCooldownMax<'info> {
    #[account(mut)]
...
pub fn admin_update_withdraw_cooldown_max(
    ...
    ctx.accounts.admin_pool.withdraw_cooldown_max = new_withdraw_cooldown_max;
    emit!(AdminPoolUpdateWithdrawCooldownMaxEvent {
